...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [[NSUserDefaults standardUserDefaults] setObject:nil forKey:@"userStartLocationDict"];
    [[NSUserDefaults standardUserDefaults] setObject:nil forKey:@"userEndLocationDict"];
